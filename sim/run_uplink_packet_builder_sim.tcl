# Vivado batch simulation for unified uplink_packet_builder.
# Usage:
#   vivado -mode batch -source sim/run_uplink_packet_builder_sim.tcl

set script_dir [file normalize [file dirname [info script]]]
set src_dir    [file normalize [file join $script_dir ..]]
set work_dir   [file normalize [file join $script_dir xsim_uplink_packet_builder]]
set proj_name  uplink_packet_builder_sim
...
add_files -fileset sim_1 [list \
    [file join $script_dir tb_uplink_packet_builder.sv] \
]
set_property file_type SystemVerilog [get_files [file join $script_dir tb_uplink_packet_builder.sv]]
set_property top tb_uplink_packet_builder [get_filesets sim_1]
...
set result_file [file join $sim_dir tb_uplink_packet_builder.result]
...
puts "TEST PASSED: unified uplink packet builder simulation."
