# Vivado batch simulation for GPX2 SPI configuration and readback.
# Usage:
#   $env:VIVADO_BIN -mode batch -source sim/run_gpx2_spi_config_sim.tcl

set script_dir [file normalize [file dirname [info script]]]
set src_dir    [file normalize [file join $script_dir ..]]
set work_dir   [file normalize [file join $script_dir xsim_gpx2_spi_config]]
set proj_name  gpx2_spi_config_sim
...
add_files -fileset sources_1 [list \
    [file join $src_dir gpx2_spi_config.v] \
]
add_files -fileset sim_1 [list \
    [file join $script_dir tb_gpx2_spi_config.sv] \
]
set_property file_type SystemVerilog [get_files [file join $script_dir tb_gpx2_spi_config.sv]]
set_property top tb_gpx2_spi_config [get_filesets sim_1]
...
set result_file [file join $sim_dir tb_gpx2_spi_config.result]
...
puts "TEST PASSED: GPX2 SPI configuration simulation."
