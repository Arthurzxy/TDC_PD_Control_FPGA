# Vivado batch simulation for unified uplink packetizer through ft601_fifo_if TX path.
# Usage:
#   vivado -mode batch -source sim/run_uplink_ft601_tx_sim.tcl

set script_dir [file normalize [file dirname [info script]]]
set src_dir    [file normalize [file join $script_dir ..]]
set work_dir   [file normalize [file join $script_dir xsim_uplink_ft601_tx]]
set proj_name  uplink_ft601_tx_sim
...
add_files -fileset sim_1 [list \
    [file join $script_dir tb_uplink_ft601_tx.sv] \
]
set_property file_type SystemVerilog [get_files [file join $script_dir tb_uplink_ft601_tx.sv]]
set_property top tb_uplink_ft601_tx [get_filesets sim_1]
...
set result_file [file join $sim_dir tb_uplink_ft601_tx.result]
...
puts "TEST PASSED: uplink to FT601 TX simulation."
