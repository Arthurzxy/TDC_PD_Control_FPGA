# Vivado batch simulation for GPX2 DDR LVDS receiver.
# Usage:
#   vivado -mode batch -source sim/run_gpx2_lvds_rx_ddr_sim.tcl

set script_dir [file normalize [file dirname [info script]]]
set src_dir    [file normalize [file join $script_dir ..]]
set work_dir   [file normalize [file join $script_dir xsim_gpx2_lvds_rx_ddr]]
set proj_name  gpx2_lvds_rx_ddr_sim
...
add_files -fileset sim_1 [list \
    [file join $script_dir tb_gpx2_lvds_rx_ddr.sv] \
]
set_property file_type SystemVerilog [get_files [file join $script_dir tb_gpx2_lvds_rx_ddr.sv]]
set_property top tb_gpx2_lvds_rx_ddr [get_filesets sim_1]
...
set result_file [file join $sim_dir tb_gpx2_lvds_rx_ddr.result]
...
puts "TEST PASSED: GPX2 DDR LVDS receiver simulation."
